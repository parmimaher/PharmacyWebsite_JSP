...
<body>
	...
	<br />
	<p align="center">
		<a href="nou_farmacie.jsp"><b>Add a new pharmacy.</b></a> <a
			href="index.html"><b>Home</b></a>
	</p>
	<%
	jb.connect();
	int aux = java.lang.Integer.parseInt(request.getParameter("id_pharmacy"));
	String pharmacy_name = request.getParameter("pharmacy_name");
	String pharmacy_website = request.getParameter("pharmacy_website");
	String[] valori = { pharmacy_name, pharmacy_website};
	String[] campuri = { "pharmacy_name", "pharmacy_website"};
	jb.modificaTabela("pharmacies", "id_pharmacy", aux, campuri, valori);
	jb.disconnect();
	%>
